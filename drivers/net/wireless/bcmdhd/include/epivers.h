...
#define EPI_COMMIT_ID		"(b17dd2e)"

/* Driver Version String, ASCII, 32 chars max */
#if defined (WLTEST)
#define EPI_VERSION_STR		"101.10.591.118 (WLTEST)"
#elif (defined (BCMDBG_ASSERT) && !defined (BCMDBG_ASSERT_DISABLED))
#define EPI_VERSION_STR		"101.10.591.118 (ASSRT)"
#else
#define EPI_VERSION_STR		"101.10.591.118.74 (20260203-6)"
#endif /* BCMINTERNAL */
